...
\begin{center}
    \includegraphics[scale=.3]{Data/StoryBoard/Effetuare_ordine.png}
\end{center}
\begin{itemize}
...
\begin{center}
    \includegraphics[scale=.3]{Data/StoryBoard/risoluzione disguidi alla cosegna.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=.3]{Data/StoryBoard/Recensione_ristorante.png}
\end{center}
...
\begin{center}
    \includegraphics[scale=.3]{Data/StoryBoard/Filtro_calorie.jpeg}
\end{center}
\begin{itemize}
    \item \textbf{Descrizione scenario:}
    \item \textbf{Descrizione task:}
